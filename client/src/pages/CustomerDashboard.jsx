...
import { 
    ...
    ArrowUpRight, ArrowDownLeft, CheckCircle2, AlertCircle, Send, Lock,
    CreditCard, Activity, Download
} from 'lucide-react';
          ...
          {/* SIDEBAR */}
            <aside className="hidden md:flex flex-col h-full py-8 px-4 bg-slate-50 w-64 border-r border-slate-200/60 shrink-0 z-20">
                ...
                <nav className="flex-1 space-y-2">
                    <button onClick={() => navigate('/dashboard')} className="w-full flex items-center gap-4 py-3 text-emerald-600 font-bold border-r-4 border-emerald-500 pl-4 bg-emerald-50/50 text-left">
